  ...
  void LerTemp()
{
  ...
  if(sensor<Temp)                            // Analisa a temperatura do forno e a compara com o preset feito pelo operador
    ...
    {TBCCR1=0;fornoquente=1;}                     // Se temperatura do forno é maior do que o preset o ciclo de trabalho do PWM é aprox. 10%
}
...
void main( void )
{
  WDTCTL = WDTPW + WDTHOLD;                 // Stop watchdog timer to prevent time out reset
   ...
   ADC12CTL0 = ADC12ON+SHT0_2;               // liga o ADC12, e define tempo de amostragem,além de habilitar a conversão
